    ...
    .container
      ...
      .pay-list
        ...
        .b
          ...
          .item
            .checkbox.checked
            img.icon(src='/static/images/wxpay.png')
            .name 微信支付
      .tips 小程序只支持微信支付，如需其它支付方式，请在网页版支付
      .pay-btn(@click='startPay') 确定
</template>
...
export default {
  ...
  beforeMount () {
    ...
    this.actualPrice = +query.actualPrice
  },
  ...
  methods: {
    ...
    requestPayParam () {
      let that = this
      util
        .request(api.PayPrepayId, { orderId: that.orderId, payType: 1 })
        .then(function (res) {
          if (res.errno === 0) {
