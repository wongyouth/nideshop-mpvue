  ...
  .feedback
    .container
      picker(@change='bindPickerChange' :value='index' :range='array')
        .picker
          .fb-type
            .type-label {{array[index]}}
            img.type-icon(src='http://yanxuan.nosdn.127.net/hxm/yanxuan-wap/p/20161201/style/img/icon-normal/pickerArrow-a8b918f05f.png')
      .fb-body
        textarea.content(
